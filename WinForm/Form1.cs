...
namespace WinForm
{
    public partial class Form1 : Form
    {
        ...
        private async void LoadDataForReps()
        {

            try
            {

                RestResponse<Reps> restResponse = await JsonConversions.GetDataRep(URL_teams);
                Reps[]? repDatas = JsonConversions.DeserializeResponseList(restResponse);
        ...
        private void RemoveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            sourceControl.pictureBox1.Image = Properties.Resources.DefaultPlayerPic1;
        ...
        private void Form1_FormClosin(Object sender, FormClosingEventArgs e)
        {
            DialogResult obj = MessageBox.Show("Are you sure you want to exit?", "Exit", MessageBoxButtons.YesNo);
